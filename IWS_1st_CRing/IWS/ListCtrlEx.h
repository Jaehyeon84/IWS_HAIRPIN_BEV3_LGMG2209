...
public:
	...
	void SetDisplayEditorFlag (BOOL bEtat);			//Add by MaxMax14 le 06/05/12: mise ?true/false de m_bDisplayEditorCalled
	BOOL GetDisplayEditorFlag ();					//Add by MaxMax14 le 06/05/12: Renvoi ?at (true/false) de m_bDisplayEditorCalled
	...
	void SetPenStyle (int iStyle);					//D?inie type de trait //ex: PS_SOLID PS_DASH PS_DOT //Add by MaxMax14 le 05/10/13
	void SetPenStyleColor (COLORREF clrPenStyle);	//D?inie Couleur //Add by MaxMax14 le 05/10/13
	void SetBordureActive (BOOL bBordure);			//D?inie si on dessine la bordure //Add by MaxMax14 le 05/10/13
