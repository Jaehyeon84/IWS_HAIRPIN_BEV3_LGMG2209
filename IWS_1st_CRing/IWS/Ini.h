...
protected:	
	...
	static void __IntToString(int nNumber, LPTSTR lpBuffer, DWORD dwBufSize, int nBase);
	static void __UIntToString(UINT nNumber, LPTSTR lpBuffer, DWORD dwBufSize, int nBase);
