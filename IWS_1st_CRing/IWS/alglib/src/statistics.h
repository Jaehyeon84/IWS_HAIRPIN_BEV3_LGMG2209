...
void _root_covm(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_pearsoncorrm(/* Real    */ ae_matrix* x,
    ...
    /* Real    */ ae_matrix* c, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_pearsoncorrm(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spearmancorrm(/* Real    */ ae_matrix* x,
    ...
    /* Real    */ ae_matrix* c, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spearmancorrm(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_covm2(/* Real    */ ae_matrix* x,
    ...
    /* Real    */ ae_matrix* c, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_covm2(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_pearsoncorrm2(/* Real    */ ae_matrix* x,
    ...
    /* Real    */ ae_matrix* c, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_pearsoncorrm2(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spearmancorrm2(/* Real    */ ae_matrix* x,
    ...
    /* Real    */ ae_matrix* c, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spearmancorrm2(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_rankdata(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_rankdatacentered(/* Real    */ ae_matrix* xy,
    ...
    ae_int_t nfeatures, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_rankdatacentered(ae_task_data *_data, ae_state *_state);
#endif
