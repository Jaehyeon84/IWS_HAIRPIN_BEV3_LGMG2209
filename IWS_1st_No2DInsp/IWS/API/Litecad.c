...
typedef BOOL (LCAPI *tflcTIN_Clear)();
tflcTIN_Clear pflcTIN_Clear = 0;

typedef BOOL (LCAPI *tflcTIN_FileLoad)(LPCWSTR szFileName, HANDLE hLcWnd);
tflcTIN_FileLoad pflcTIN_FileLoad = 0;

typedef BOOL (LCAPI *tflcTIN_FileSave)(LPCWSTR szFileName, HANDLE hLcWnd);
tflcTIN_FileSave pflcTIN_FileSave = 0;

typedef BOOL (LCAPI *tflcTIN_Update)();
tflcTIN_Update pflcTIN_Update = 0;

typedef HANDLE (LCAPI *tflcTIN_AddPoint)(double X, double Y, double Z);
tflcTIN_AddPoint pflcTIN_AddPoint = 0;

typedef HANDLE (LCAPI *tflcTIN_AddPoint2)(double X, double Y, double Z, LPCWSTR szName, LPCWSTR szDescr, int iColor);
tflcTIN_AddPoint2 pflcTIN_AddPoint2 = 0;

typedef int (LCAPI *tflcTIN_LoadPoints)(LPCWSTR szFileName, HANDLE hLcWnd);
tflcTIN_LoadPoints pflcTIN_LoadPoints = 0;

typedef int (LCAPI *tflcTIN_DelDupPoints)(double Delta);
tflcTIN_DelDupPoints pflcTIN_DelDupPoints = 0;

typedef BOOL (LCAPI *tflcTIN_DelPoint)(HANDLE hPnt);
tflcTIN_DelPoint pflcTIN_DelPoint = 0;

typedef HANDLE (LCAPI *tflcTIN_GetFirstPoint)();
tflcTIN_GetFirstPoint pflcTIN_GetFirstPoint = 0;

typedef HANDLE (LCAPI *tflcTIN_GetNextPoint)(HANDLE hPnt);
tflcTIN_GetNextPoint pflcTIN_GetNextPoint = 0;

typedef HANDLE (LCAPI *tflcTIN_GetPointI)(int Index);
tflcTIN_GetPointI pflcTIN_GetPointI = 0;

typedef HANDLE (LCAPI *tflcTIN_AddTrian)(HANDLE hPnt1, HANDLE hPnt2, HANDLE hPnt3);
tflcTIN_AddTrian pflcTIN_AddTrian = 0;

typedef HANDLE (LCAPI *tflcTIN_AddTrianI)(int iPnt1, int iPnt, int iPnt3);
tflcTIN_AddTrianI pflcTIN_AddTrianI = 0;

typedef BOOL (LCAPI *tflcTIN_DelTrian)(HANDLE hTrian);
tflcTIN_DelTrian pflcTIN_DelTrian = 0;

typedef int (LCAPI *tflcTIN_DelTriansByPline)(HANDLE hPline);
tflcTIN_DelTriansByPline pflcTIN_DelTriansByPline = 0;

typedef HANDLE (LCAPI *tflcTIN_GetFirstTrian)();
tflcTIN_GetFirstTrian pflcTIN_GetFirstTrian = 0;

typedef HANDLE (LCAPI *tflcTIN_GetNextTrian)(HANDLE hTrian);
tflcTIN_GetNextTrian pflcTIN_GetNextTrian = 0;

typedef BOOL (LCAPI *tflcTIN_NormTrians)();
tflcTIN_NormTrians pflcTIN_NormTrians = 0;

typedef BOOL (LCAPI *tflcTIN_Triangulate)();
tflcTIN_Triangulate pflcTIN_Triangulate = 0;

typedef BOOL (LCAPI *tflcTIN_BndClear)();
tflcTIN_BndClear pflcTIN_BndClear = 0;

typedef BOOL (LCAPI *tflcTIN_BndAuto)(double MaxDist, HANDLE hLcWnd);
tflcTIN_BndAuto pflcTIN_BndAuto = 0;

typedef BOOL (LCAPI *tflcTIN_BndAddPoint)(HANDLE hPnt);
tflcTIN_BndAddPoint pflcTIN_BndAddPoint = 0;

typedef BOOL (LCAPI *tflcTIN_BndUpdate)();
tflcTIN_BndUpdate pflcTIN_BndUpdate = 0;

typedef HANDLE (LCAPI *tflcTIN_BndGetPoint)(int iPnt);
tflcTIN_BndGetPoint pflcTIN_BndGetPoint = 0;

typedef BOOL (LCAPI *tflcTIN_BndFileSave)(LPCWSTR szFileName, HANDLE hLcWnd);
tflcTIN_BndFileSave pflcTIN_BndFileSave = 0;

typedef int (LCAPI *tflcTIN_BndOffset)(double dX, double dY, double dZ);
tflcTIN_BndOffset pflcTIN_BndOffset = 0;

typedef BOOL (LCAPI *tflcTIN_GetZ)(double X, double Y, double* pZ);
tflcTIN_GetZ pflcTIN_GetZ = 0;

typedef int (LCAPI *tflcTIN_InterLine)(double X0, double Y0, double X1, double Y1);
tflcTIN_InterLine pflcTIN_InterLine = 0;

typedef BOOL (LCAPI *tflcTIN_InterGetPoint)(int iPnt, double* pX, double* pY, double* pZ);
tflcTIN_InterGetPoint pflcTIN_InterGetPoint = 0;

typedef HANDLE (LCAPI *tflcTIN_GetNearPoint)(double X, double Y);
tflcTIN_GetNearPoint pflcTIN_GetNearPoint = 0;

typedef int (LCAPI *tflcTIN_GenIsolines)();
tflcTIN_GenIsolines pflcTIN_GenIsolines = 0;

typedef HANDLE (LCAPI *tflcTIN_GetFirstIso)();
tflcTIN_GetFirstIso pflcTIN_GetFirstIso = 0;

typedef HANDLE (LCAPI *tflcTIN_GetNextIso)(HANDLE hIso);
tflcTIN_GetNextIso pflcTIN_GetNextIso = 0;

typedef double (LCAPI *tflcTIN_IsoGetHeight)(HANDLE hIso);
tflcTIN_IsoGetHeight pflcTIN_IsoGetHeight = 0;

typedef int (LCAPI *tflcTIN_IsoGetNumVers)(HANDLE hIso);
tflcTIN_IsoGetNumVers pflcTIN_IsoGetNumVers = 0;

typedef BOOL (LCAPI *tflcTIN_IsoIsClosed)(HANDLE hIso);
tflcTIN_IsoIsClosed pflcTIN_IsoIsClosed = 0;
...
typedef HANDLE (LCAPI *tflcTIN_IsoGetFirstVer)(HANDLE hIso);
tflcTIN_IsoGetFirstVer pflcTIN_IsoGetFirstVer = 0;

typedef HANDLE (LCAPI *tflcTIN_IsoGetNextVer)(HANDLE hIso, HANDLE hVer);
tflcTIN_IsoGetNextVer pflcTIN_IsoGetNextVer = 0;

typedef BOOL (LCAPI *tflcTIN_IsoGetVerXY)(HANDLE hVer, double* pX, double* pY);
tflcTIN_IsoGetVerXY pflcTIN_IsoGetVerXY = 0;
...
typedef BOOL (LCAPI *tflcDrwSaveCB)(HANDLE hDrw);
tflcDrwSaveCB pflcDrwSaveCB = 0;

typedef BOOL (LCAPI *tflcDrwLoadCB)(HANDLE hDrw, HANDLE hLcWnd);
tflcDrwLoadCB pflcDrwLoadCB = 0;
...
typedef BOOL (LCAPI *tflcBlockScale)(HANDLE hBlock, double X, double Y, double Scale, BOOL bUpdate);
...
typedef HANDLE (LCAPI *tflcBlockAddImageRefUns)(HANDLE hBlock, HANDLE hImage, double X, double Y, double Scale, int Align, BOOL bBorder);
...
typedef HANDLE (LCAPI *tflcBlockJoinAll)(HANDLE hBlock, double Delta);
...
typedef HANDLE (LCAPI *tflcBlockGetBlkRefByTag)(HANDLE hBlock, LPCWSTR szTag, LPCWSTR szValue, BOOL bSelect);
...
typedef BOOL (LCAPI *tflcPrintBlock)(HANDLE hBlock, double X, double Y, double W, double H, double Scale, double PapLef, double PapTop, int Options);
...
BOOL SetProcAddr ()
{
  ...
  szFuncName = "lcTIN_FileLoad";
  pflcTIN_FileLoad = (tflcTIN_FileLoad)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_FileLoad == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_FileSave";
  pflcTIN_FileSave = (tflcTIN_FileSave)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_FileSave == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_Update";
  pflcTIN_Update = (tflcTIN_Update)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_Update == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcTIN_AddPoint2";
  pflcTIN_AddPoint2 = (tflcTIN_AddPoint2)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_AddPoint2 == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_LoadPoints";
  pflcTIN_LoadPoints = (tflcTIN_LoadPoints)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_LoadPoints == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_DelDupPoints";
  pflcTIN_DelDupPoints = (tflcTIN_DelDupPoints)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_DelDupPoints == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_DelPoint";
  pflcTIN_DelPoint = (tflcTIN_DelPoint)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_DelPoint == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetFirstPoint";
  pflcTIN_GetFirstPoint = (tflcTIN_GetFirstPoint)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetFirstPoint == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetNextPoint";
  pflcTIN_GetNextPoint = (tflcTIN_GetNextPoint)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetNextPoint == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetPointI";
  pflcTIN_GetPointI = (tflcTIN_GetPointI)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetPointI == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcTIN_AddTrianI";
  pflcTIN_AddTrianI = (tflcTIN_AddTrianI)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_AddTrianI == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_DelTrian";
  pflcTIN_DelTrian = (tflcTIN_DelTrian)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_DelTrian == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_DelTriansByPline";
  pflcTIN_DelTriansByPline = (tflcTIN_DelTriansByPline)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_DelTriansByPline == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetFirstTrian";
  pflcTIN_GetFirstTrian = (tflcTIN_GetFirstTrian)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetFirstTrian == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetNextTrian";
  pflcTIN_GetNextTrian = (tflcTIN_GetNextTrian)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetNextTrian == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_NormTrians";
  pflcTIN_NormTrians = (tflcTIN_NormTrians)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_NormTrians == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcTIN_BndClear";
  pflcTIN_BndClear = (tflcTIN_BndClear)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_BndClear == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_BndAuto";
  pflcTIN_BndAuto = (tflcTIN_BndAuto)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_BndAuto == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_BndAddPoint";
  pflcTIN_BndAddPoint = (tflcTIN_BndAddPoint)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_BndAddPoint == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_BndUpdate";
  pflcTIN_BndUpdate = (tflcTIN_BndUpdate)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_BndUpdate == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcTIN_BndFileSave";
  pflcTIN_BndFileSave = (tflcTIN_BndFileSave)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_BndFileSave == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_BndOffset";
  pflcTIN_BndOffset = (tflcTIN_BndOffset)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_BndOffset == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcTIN_GetNearPoint";
  pflcTIN_GetNearPoint = (tflcTIN_GetNearPoint)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetNearPoint == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GenIsolines";
  pflcTIN_GenIsolines = (tflcTIN_GenIsolines)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GenIsolines == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetFirstIso";
  pflcTIN_GetFirstIso = (tflcTIN_GetFirstIso)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetFirstIso == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_GetNextIso";
  pflcTIN_GetNextIso = (tflcTIN_GetNextIso)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_GetNextIso == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_IsoGetHeight";
  pflcTIN_IsoGetHeight = (tflcTIN_IsoGetHeight)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_IsoGetHeight == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_IsoGetNumVers";
  pflcTIN_IsoGetNumVers = (tflcTIN_IsoGetNumVers)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_IsoGetNumVers == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_IsoIsClosed";
  pflcTIN_IsoIsClosed = (tflcTIN_IsoIsClosed)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_IsoIsClosed == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcTIN_IsoGetFirstVer";
  pflcTIN_IsoGetFirstVer = (tflcTIN_IsoGetFirstVer)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_IsoGetFirstVer == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_IsoGetNextVer";
  pflcTIN_IsoGetNextVer = (tflcTIN_IsoGetNextVer)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_IsoGetNextVer == NULL){
    goto mErr;
  }
  szFuncName = "lcTIN_IsoGetVerXY";
  pflcTIN_IsoGetVerXY = (tflcTIN_IsoGetVerXY)GetProcAddress( ghLibInst, szFuncName );
  if (pflcTIN_IsoGetVerXY == NULL){
    goto mErr;
  }
  ...
  szFuncName = "lcDrwSaveCB";
  pflcDrwSaveCB = (tflcDrwSaveCB)GetProcAddress( ghLibInst, szFuncName );
  if (pflcDrwSaveCB == NULL){
    goto mErr;
  }
  szFuncName = "lcDrwLoadCB";
  pflcDrwLoadCB = (tflcDrwLoadCB)GetProcAddress( ghLibInst, szFuncName );
  if (pflcDrwLoadCB == NULL){
    goto mErr;
  }
...
{
  if (pflcTIN_FileLoad){
    return (*pflcTIN_FileLoad)(szFileName, hLcWnd);
  }
  return 0;
}
...
{
  if (pflcTIN_FileSave){
    return (*pflcTIN_FileSave)(szFileName, hLcWnd);
  }
  return 0;
}
...
{
  if (pflcTIN_AddPoint2){
    return (*pflcTIN_AddPoint2)(X, Y, Z, szName, szDescr, iColor);
  }
  return 0;
}
...
{
  if (pflcTIN_LoadPoints){
    return (*pflcTIN_LoadPoints)(szFileName, hLcWnd);
  }
  return 0;
}
...
{
  if (pflcTIN_DelDupPoints){
    return (*pflcTIN_DelDupPoints)(Delta);
  }
  return 0;
}
...
{
  if (pflcTIN_GetFirstPoint){
    return (*pflcTIN_GetFirstPoint)();
  }
  return 0;
}
...
{
  if (pflcTIN_GetNextPoint){
    return (*pflcTIN_GetNextPoint)(hPnt);
  }
  return 0;
}
...
{
  if (pflcTIN_GetPointI){
    return (*pflcTIN_GetPointI)(Index);
  }
  return 0;
}
...
{
  if (pflcTIN_AddTrian){
    return (*pflcTIN_AddTrian)(hPnt1, hPnt2, hPnt3);
  }
  return 0;
}
...
{
  if (pflcTIN_AddTrianI){
    return (*pflcTIN_AddTrianI)(iPnt1, iPnt, iPnt3);
  }
  return 0;
}
...
{
  if (pflcTIN_DelTrian){
    return (*pflcTIN_DelTrian)(hTrian);
  }
  return 0;
}
...
{
  if (pflcTIN_DelTriansByPline){
    return (*pflcTIN_DelTriansByPline)(hPline);
  }
  return 0;
}
...
{
  if (pflcTIN_GetFirstTrian){
    return (*pflcTIN_GetFirstTrian)();
  }
  return 0;
}
...
{
  if (pflcTIN_GetNextTrian){
    return (*pflcTIN_GetNextTrian)(hTrian);
  }
  return 0;
}
...
{
  if (pflcTIN_NormTrians){
    return (*pflcTIN_NormTrians)();
  }
  return 0;
}
...
//--------------
BOOL LCAPI lcTIN_Triangulate ()
{
  if (pflcTIN_Triangulate){
    return (*pflcTIN_Triangulate)();
  }
  return 0;
}
...
{
  if (pflcTIN_BndAuto){
    return (*pflcTIN_BndAuto)(MaxDist, hLcWnd);
  }
  return 0;
}
...
{
  if (pflcTIN_BndAddPoint){
    return (*pflcTIN_BndAddPoint)(hPnt);
  }
  return 0;
}
...
{
  if (pflcTIN_BndUpdate){
    return (*pflcTIN_BndUpdate)();
  }
  return 0;
}
...
HANDLE LCAPI lcTIN_BndGetPoint (int iPnt)
{
  if (pflcTIN_BndGetPoint){
    return (*pflcTIN_BndGetPoint)(iPnt);
  }
  return 0;
}
...
{
  if (pflcTIN_BndFileSave){
    return (*pflcTIN_BndFileSave)(szFileName, hLcWnd);
  }
  return 0;
}
...
{
  if (pflcTIN_BndOffset){
    return (*pflcTIN_BndOffset)(dX, dY, dZ);
  }
  return 0;
}
...
int LCAPI lcTIN_InterLine (double X0, double Y0, double X1, double Y1)
{
  if (pflcTIN_InterLine){
    return (*pflcTIN_InterLine)(X0, Y0, X1, Y1);
  }
  return 0;
}
...
BOOL LCAPI lcTIN_InterGetPoint (int iPnt, double* pX, double* pY, double* pZ)
{
  if (pflcTIN_InterGetPoint){
    return (*pflcTIN_InterGetPoint)(iPnt, pX, pY, pZ);
  }
  return 0;
}
...
{
  if (pflcTIN_GetNearPoint){
    return (*pflcTIN_GetNearPoint)(X, Y);
  }
  return 0;
}
...
{
  if (pflcTIN_GenIsolines){
    return (*pflcTIN_GenIsolines)();
  }
  return 0;
}
...
{
  if (pflcTIN_GetFirstIso){
    return (*pflcTIN_GetFirstIso)();
  }
  return 0;
}
...
{
  if (pflcTIN_GetNextIso){
    return (*pflcTIN_GetNextIso)(hIso);
  }
  return 0;
}
...
{
  if (pflcTIN_IsoGetHeight){
    return (*pflcTIN_IsoGetHeight)(hIso);
  }
  return 0;
}
...
{
  if (pflcTIN_IsoGetNumVers){
    return (*pflcTIN_IsoGetNumVers)(hIso);
  }
  return 0;
}
...
{
  if (pflcTIN_IsoIsClosed){
    return (*pflcTIN_IsoIsClosed)(hIso);
  }
  return 0;
}
...
{
  if (pflcTIN_IsoGetFirstVer){
    return (*pflcTIN_IsoGetFirstVer)(hIso);
  }
  return 0;
}
...
{
  if (pflcTIN_IsoGetNextVer){
    return (*pflcTIN_IsoGetNextVer)(hIso, hVer);
  }
  return 0;
}
...
{
  if (pflcTIN_IsoGetVerXY){
    return (*pflcTIN_IsoGetVerXY)(hVer, pX, pY);
  }
  return 0;
}
...
{
  if (pflcDrwLoadCB){
    return (*pflcDrwLoadCB)(hDrw, hLcWnd);
  }
  return 0;
}
...
{
  if (pflcBlockScale){
    return (*pflcBlockScale)(hBlock, X, Y, Scale, bUpdate);
  }
  return 0;
}
...
HANDLE LCAPI lcBlockAddImageRefUns (HANDLE hBlock, HANDLE hImage, double X, double Y, double Scale, int Align, BOOL bBorder)
{
  if (pflcBlockAddImageRefUns){
    return (*pflcBlockAddImageRefUns)(hBlock, hImage, X, Y, Scale, Align, bBorder);
  }
  return 0;
}
...
HANDLE LCAPI lcBlockGetBlkRefByTag (HANDLE hBlock, LPCWSTR szTag, LPCWSTR szValue, BOOL bSelect)
{
  if (pflcBlockGetBlkRefByTag){
    return (*pflcBlockGetBlkRefByTag)(hBlock, szTag, szValue, bSelect);
  }
  return 0;
}
...
{
  if (pflcPrintBlock){
    return (*pflcPrintBlock)(hBlock, X, Y, W, H, Scale, PapLef, PapTop, Options);
  }
  return 0;
}
