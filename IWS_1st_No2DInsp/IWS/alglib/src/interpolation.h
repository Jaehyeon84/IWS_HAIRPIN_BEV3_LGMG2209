...
#endif
#if defined(AE_COMPILE_NSFIT) || !defined(AE_PARTIAL_BUILD)
typedef struct
{
    ae_int_t nfev;
    ae_int_t iterationscount;
...
void _root_spline1dfitpenalized(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spline1dfitpenalizedw(/* Real    */ ae_vector* x,
    ...
    spline1dfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spline1dfitpenalizedw(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_polynomialfit(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_polynomialfitwc(/* Real    */ ae_vector* x,
    ...
    polynomialfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_polynomialfitwc(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_barycentricfitfloaterhormannwc(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_barycentricfitfloaterhormann(/* Real    */ ae_vector* x,
    ...
    barycentricfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_barycentricfitfloaterhormann(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spline1dfitcubicwc(/* Real    */ ae_vector* x,
    ...
    spline1dfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spline1dfitcubicwc(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spline1dfithermitewc(/* Real    */ ae_vector* x,
    ...
    spline1dfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spline1dfithermitewc(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spline1dfitcubic(/* Real    */ ae_vector* x,
    ...
    spline1dfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spline1dfitcubic(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_spline1dfithermite(/* Real    */ ae_vector* x,
    ...
    spline1dfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_spline1dfithermite(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_lsfitlinearw(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_lsfitlinearwc(/* Real    */ ae_vector* y,
    ...
    lsfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_lsfitlinearwc(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_lsfitlinear(/* Real    */ ae_vector* y,
    ...
    lsfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_lsfitlinear(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_lsfitlinearc(/* Real    */ ae_vector* y,
    ...
    lsfitreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_lsfitlinearc(ae_task_data *_data, ae_state *_state);
#endif
...
void nsfitsphereinternal(/* Real    */ ae_matrix* xy,
     ...
     ae_state *_state);
void _nsfitinternalreport_init(void* _p, ae_state *_state, ae_bool make_automatic);
void _nsfitinternalreport_init_copy(void* _dst, void* _src, ae_state *_state, ae_bool make_automatic);
...
void _pexec_rbfgridcalc2v(rbfmodel* s,
    ...
    /* Real    */ ae_vector* y, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_rbfgridcalc2v(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_rbfgridcalc2vsubset(rbfmodel* s,
    ...
    /* Real    */ ae_vector* y, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_rbfgridcalc2vsubset(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_rbfgridcalc3v(rbfmodel* s,
    ...
    /* Real    */ ae_vector* y, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_rbfgridcalc3v(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_rbfgridcalc3vsubset(rbfmodel* s,
    ...
    /* Real    */ ae_vector* y, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_rbfgridcalc3vsubset(ae_task_data *_data, ae_state *_state);
#endif
