/*************************************************************************
ALGLIB 3.13.1 (source code generated 2018-01-19)
Copyright (c) Sergey Bochkanov (ALGLIB project).

>>> SOURCE LICENSE >>>
This  program  is  a  Commercial Edition  of the ALGLIB package  licensed
to VINE (Licensee), agreement ID is AGR-20170309-1
...
void _root_pcabuildbasis(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_pcatruncatedsubspace(/* Real    */ ae_matrix* x,
    ...
    /* Real    */ ae_matrix* v, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_pcatruncatedsubspace(ae_task_data *_data, ae_state *_state);
#endif
#endif
#if defined(AE_COMPILE_BDSS) || !defined(AE_PARTIAL_BUILD)
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlperror(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlperrorsparse(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlperrorsparse(ae_task_data *_data, ae_state *_state);
#endif
...
ae_int_t _pexec_mlpclserror(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpclserror(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlprelclserror(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlprelclserror(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlprelclserrorsparse(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlprelclserrorsparse(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlpavgce(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpavgce(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlpavgcesparse(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpavgcesparse(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlprmserror(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlprmserror(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlprmserrorsparse(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlprmserrorsparse(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlpavgerror(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpavgerror(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlpavgerrorsparse(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpavgerrorsparse(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlpavgrelerror(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpavgrelerror(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlpavgrelerrorsparse(multilayerperceptron* network,
    ...
    ae_int_t npoints, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpavgrelerrorsparse(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpgradbatch(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_mlpgradbatchsparse(multilayerperceptron* network,
    ...
    /* Real    */ ae_vector* grad, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpgradbatchsparse(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_mlpgradbatchsubset(multilayerperceptron* network,
    ...
    /* Real    */ ae_vector* grad, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpgradbatchsubset(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_mlpgradbatchsparsesubset(multilayerperceptron* network,
    ...
    /* Real    */ ae_vector* grad, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpgradbatchsparsesubset(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpallerrorssubset(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_mlpallerrorssparsesubset(multilayerperceptron* network,
    ...
    modelerrors* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpallerrorssparsesubset(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlperrorsubset(ae_task_data *_data, ae_state *_state);
#endif
...
double _pexec_mlperrorsparsesubset(multilayerperceptron* network,
    ...
    ae_int_t subsetsize, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlperrorsparsesubset(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_fisherldan(ae_task_data *_data, ae_state *_state);
#endif
#endif
#if defined(AE_COMPILE_SSA) || !defined(AE_PARTIAL_BUILD)
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpkfoldcv(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_mlptrainnetwork(mlptrainer* s,
    ...
    mlpreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlptrainnetwork(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlpcontinuetraining(ae_task_data *_data, ae_state *_state);
#endif
...
void _pexec_mlptrainensemblees(mlptrainer* s,
    ...
    mlpreport* rep, ae_state *_state);
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_mlptrainensemblees(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_clusterizerrunahc(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_clusterizerrunkmeans(ae_task_data *_data, ae_state *_state);
#endif
...
#if defined(_ALGLIB_HAS_WORKSTEALING)
void _root_clusterizergetdistances(ae_task_data *_data, ae_state *_state);
#endif
