...
public:
	...
	afx_msg void OnBnClickedReworkSelect();
	afx_msg void OnBnClickedBtnReinitPlc();
	afx_msg void OnBnClickedBtnHcompTest();

//	void HCompTestSave(double dHeight, TCHAR* szFileName);
	void HCompTestSave(double dHeight, TCHAR* szFileName, int nModelNo, int nJigNo);
	
	// dhpark 2023.06.26
	//afx_msg void OnBnClickedBtn2dSet();	//gseom_240704_2DInsp 주석 추가

	
	//afx_msg void OnButton2dResult();		//gseom_240704_2DInsp 주석 추가
};
