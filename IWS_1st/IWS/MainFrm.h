...
public:
	...
	afx_msg void OnUpdateFileShowInspect(CCmdUI *pCmdUI);
	afx_msg void OnUpdateFileDxf(CCmdUI *pCmdUI);
	afx_msg void OnUpdateFileHpConfig(CCmdUI *pCmdUI);
	afx_msg void OnUpdateFileSetVscan(CCmdUI *pCmdUI);
	afx_msg void OnUpdateFileLocationSave(CCmdUI *pCmdUI);
	afx_msg void OnUpdateFileLoadAs(CCmdUI *pCmdUI);
	afx_msg void OnUpdateMatrix(CCmdUI *pCmdUI);
	afx_msg void OnUpdateMatrixPcc(CCmdUI *pCmdUI);
	afx_msg void OnUpdateButtonHairpin(CCmdUI *pCmdUI);
	afx_msg void OnUpdateButtonHairpinConfig(CCmdUI *pCmdUI);
	afx_msg void OnUpdateButtonHairpinOffset(CCmdUI *pCmdUI);
	afx_msg void OnUpdateButtonPattern(CCmdUI *pCmdUI);
	afx_msg void OnUpdateButtonLaserPens(CCmdUI *pCmdUI);
