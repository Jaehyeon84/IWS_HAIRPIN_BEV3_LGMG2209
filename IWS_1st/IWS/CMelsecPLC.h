...
#define PLC_WORD_RECIPE		6  // 0=None, 1=77 JigA, 2= 77 JigB, 3 = 76 JigA, 4 = 76 JigB
...
#define PLC_WORD_2DINSP_JIGA   10  // 0=None, 1=Do Inspection
#define PLC_WORD_2DINSP_JIGB   17  // 0=None, 1=Do Inspection

#define PLC_WORD_TIME		11 // 6 WORD
#define PLC_WORD_LOTID_JIGA		18 // @ WORD LotID
#define PLC_WORD_LOTID_JIGB		30 // @ WORD LotID

// sjyi 2023.07.14 2D검사를 위해 추가 
#define PLC_WORD_WRITE_DO_2DINSPECT 5
#define PLC_WORD_WRITE_2D_RESULT 6

#define PLC_WORD_PATTERN_MAIN		20
#define PLC_WORD_PATTERN_SUPPORT	30
...
public:
	...
	BOOL GetReqInspectOld();
	void SetReqInspectOld(BOOL bValue);
	...
	void UpdateDateTime(BOOL bUpdate);
	...
	void SetPattern(const char *sPtrn1, const char *sPtrn2);

	// sjyi 2023.07.14 2D 검사를 위해 함수 추가 
	void SetDo2DInspect(int nDoInspection);
	void Set2DInspectResultJigA(int nResult);
	void Set2DInspectResultJigB(int nResult);

	int  GetDo2DInspectJigA();
	int  GetDo2DInspectJigB();

	// sjyi 2023.07.17 LOT ID
	CString GetLOTID();
