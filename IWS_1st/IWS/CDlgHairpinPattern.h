...
protected:
	...
	CAutoEditInt m_editSlotNo1st;
	CAutoEditInt m_editSlotNo2nd;
...
public:
	...
	int m_n1STSlot;			// 1차패턴 슬롯 번호(변경할 슬롯 번호)
	...
	int m_n2NDSlot;			// 2차패턴 슬롯 번호(변경할 슬롯 번호)
	...
	double m_dPtnRotation2; // 2차 패턴 패턴 회전 각도, sjyi 2023.04.14 패턴 회전 속성 추가 - 2차 패턴
	...
	// 전체설정 속성
	//////////////////////////////////////////////////////////////////////////////
	BOOL m_bUseReversal;	// 헤어핀 외경(짝수열) 패턴 반전 기능 사용여부, sjyi 2024.02.28 추가
	BOOL m_bUseSlotMode;	// Slot 선택 모드 사용 유무, sjyi 2024.05.26  추가
...
protected:
	...
	afx_msg void OnBnClickedCheckUseSlot();
	...
	void UpdateUI_SlotNode();	// sjyi 2024.05.27 Slot모드 변경에 따른 UI 업데이트
