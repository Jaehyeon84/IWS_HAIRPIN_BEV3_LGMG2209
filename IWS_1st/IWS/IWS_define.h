...
#define WORK_VER111	   111		// sjyi 2025.10.17 소티 반복 맵 추가
#define WORK_VERC	   WORK_VER111
...
#define MATRIX_DIVISION_MAX 32
// sjyi 2024.10.20 Matrix 분할 환경설정으로 변경(4분할, 8분할, 16분할)
...
typedef struct _IWS_HAIRPIN_INFO_V110 {
	int nSlot;				// Slot 개수
	int nDrawSlot;			// 화면에 표시할 Slot 개수(실제 용접할 Slot)
	int nLayer;				// Layer 개수
	int nGenDir;			// 헤어핀 생성 방향(0 - CCW, 1 - CW
