...
BEGIN_MESSAGE_MAP(CDlgHairpinOffset, CDialogEx)
	...
	ON_BN_CLICKED(IDC_RADIO_3D, &CDlgHairpinOffset::OnClickedRadioRcp3d)
	ON_BN_CLICKED(IDC_RADIO_2D, &CDlgHairpinOffset::OnClickedRadioRcp2d)
	ON_BN_CLICKED(IDC_BUTTON_ALL_SET, &CDlgHairpinOffset::OnBnClickedButtonAllSet)
	ON_BN_CLICKED(IDC_BUTTON_RCP_ENABLE, &CDlgHairpinOffset::OnBnClickedButtonRcpEnable)
END_MESSAGE_MAP()
