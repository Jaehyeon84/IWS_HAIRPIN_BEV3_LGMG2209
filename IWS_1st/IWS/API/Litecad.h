/********************************************************************
* Project: LiteCAD DLL
* Copyright (c) 2009-2020, Oleg Kolbaskin.
* All rights reserved.
*
...
#define LC_HELP_DG_NDLSET       50
#define LC_HELP_DG_LMESH        51
#define LC_HELP_DG_CRECTS       52
#define LC_HELP_DG_SELLINFILL   53

// values for lcWndMessage uType parameter
#define LC_MB_OK                0     //0x0000L The message box contains one push button: OK. This is the default.
#define LC_MB_OKCANCEL          1     //0x0001L The message box contains two push buttons: OK and Cancel.
#define LC_MB_ABORTRETRYIGNORE  2     //0x0002L The message box contains three push buttons: Abort, Retry, and Ignore.
#define LC_MB_YESNOCANCEL       3     //0x0003L The message box contains three push buttons: Yes, No, and Cancel.
#define LC_MB_YESNO             4     //0x0004L The message box contains two push buttons: Yes and No.
#define LC_MB_RETRYCANCEL       5     //0x0005L The message box contains two push buttons: Retry and Cancel.
#define LC_MB_CANCELTRYCONTINUE 6     //0x0006L The message box contains three push buttons: Cancel, Try Again, Continue. Use this message box type instead of MB_ABORTRETRYIGNORE.
#define LC_MB_HELP              16384 //0x4000L Adds a Help button to the message box. When the user clicks the Help button or presses F1, the system sends a WM_HELP message to the owner.
#define LC_MB_ICONSTOP          16    //0x0010L A stop-sign icon appears in the message box.
#define LC_MB_ICONERROR         16    //0x0010L A stop-sign icon appears in the message box.
#define LC_MB_ICONHAND          16    //0x0010L A stop-sign icon appears in the message box.
#define LC_MB_ICONQUESTION      32    //0x0020L A question-mark icon appears in the message box. 
#define LC_MB_ICONEXCLAMATION   48    //0x0030L An exclamation-point icon appears in the message box.
#define LC_MB_ICONWARNING       48    //0x0030L An exclamation-point icon appears in the message box.
#define LC_MB_ICONINFORMATION   64    //0x0040L An icon consisting of a lowercase letter i in a circle appears in the message box.
#define LC_MB_ICONASTERISK      64    //0x0040L An icon consisting of a lowercase letter i in a circle appears in the message box.
...
#define LC_CMD_EDITMODE_ON    429  // 
#define LC_CMD_EDITMODE_OFF   430  // 
...
#define LC_CMD_TIN_CLEAR      251   // TIN: clear all
#define LC_CMD_TIN_LOAD       252   // TIN: File load
#define LC_CMD_TIN_SAVE       253   // TIN: File save
#define LC_CMD_TIN_PROPS      254   // TIN: Properties
#define LC_CMD_TIN_ADDPT      255   // TIN: add Point
#define LC_CMD_TIN_LOADPT     256   // TIN: load Points fro a file
#define LC_CMD_TIN_EDITPT     257   // TIN: edit points (dialog)
#define LC_CMD_TIN_DELPT      258   // TIN: delete points
#define LC_CMD_TIN_DELPTDUP   259   // TIN: delete duplicate points
#define LC_CMD_TIN_DELTR      260   // TIN: delete triangles
#define LC_CMD_TIN_SWAPTR     261   // TIN: swap triangles
#define LC_CMD_TIN_ZOOM       262   // TIN: zoom extents
#define LC_CMD_TIN_BND        263   // TIN: define boundary
#define LC_CMD_TIN_BNDAUTO    264   // TIN: define boundary
#define LC_CMD_TIN_BNDTRANG   265   // TIN: 
#define LC_CMD_TIN_BNDDELTR   266   // TIN: 
#define LC_CMD_TIN_BNDDELPT   267   // TIN: 
#define LC_CMD_TIN_BNDCLEAR   268   // TIN: 
#define LC_CMD_TIN_BNDSAVE    269   // TIN: 
...
#define LC_CMD_SPLIT          313  // Split entities
...
#define LC_CMD_ORDER_SEQ      317  // Sequential order 
#define LC_CMD_ALIGN          318  // align entities
...
#define LC_CMD_CLOSEBLOCK     319  // Close Block Editor
#define LC_CMD_BASEPOINT      320  // set block's basepoint 
#define LC_CMD_TRIM           321  // Trim
#define LC_CMD_EXTEND         322  // Extend
#define LC_CMD_OFFSET         323  // Offset
#define LC_CMD_OFFSET_POINT   0 
#define LC_CMD_OFFSET_DIST    1
#define LC_CMD_BREAK          324  // Break
#define LC_CMD_STRETCH        325  // Stretch
#define LC_CMD_FILLET         326  // make fillet for 2 lines
#define LC_CMD_IMGRES         331  // Change Image Resolution
#define LC_CMD_IMGPOS         332  // Set Image Position
#define LC_CMD_XHL            341  // make shape from hatch by lines
#define LC_CMD_XHP            342  // make shape from hatch by polylines
#define LC_CMD_JOINALL        345  // Join all connected entities into polylines
#define LC_CMD_ENTEXT         348  // display entities extents on/off
#define LC_CMD_JUMPS          349  // display jump lines on/off
#define LC_CMD_UNSIMG         350  // toggle flag "Unscalable" for selected raster images
...
#define LC_PROP_G_STR           24   // RW string|int; g_PropStr | mode for g_StrList
...
#define LC_PROP_G_PRNBTNRAS     27   // RW bool; visibility of button "Raster" in the "Print" dialog
#define LC_PROP_G_PRNBTNSRIF    28   // RW bool; visibility of button "Save Raster Image to File" in the "Print/Raster" dialog
#define LC_PROP_G_PNTPIXSIZE    29   // RW bool; meaning of negative PtSize parameter of lcPaint_DrawPoint function, if TRUE - size in pixels, FALSE - % of window height  // undoc
#define LC_PROP_G_GETDELENT     30   // RW bool; controls if lcBlockGetEnt... function will retrieve deleted entities or not
#define LC_PROP_G_SBARHEIGHT    32   // R  int; StatusBar default height
#define LC_PROP_G_FILEPROGRESS  33   // RW bool; Display progress box during file load/save
#define LC_PROP_G_FILEDEFEXT    35   // RW string; default extention on file open dialog
...
#define LC_PROP_G_UNDOMSG       40   // RW bool; display a message when Undo/Redo buffer is empty
...
#define LC_PROP_G_CAMERA_COUNT  70   // R  int; number of camera devices
#define LC_PROP_G_CAMERA_I      71   // RW int; set camera index
#define LC_PROP_G_CAMERA_INAME  72   // R  string; name of camera by index (LC_PROP_G_CAMERA_I)
#define LC_PROP_G_CAMERA_CONNECTED  73   // R  bool; TRUE if camera is connected
// for connected camera:
#define LC_PROP_G_CAMERA_NAME   74   // R  string; name of connected camera
...
#define LC_PROP_G_CAMERA_BPP    78   // R  int; bits per pixel
#define LC_PROP_G_CAMERA_COFO   79   // R  int; color format (LC_COFO_RGB24 and others)
#define LC_PROP_G_CAMERA_BITS   80   // R  handle|int; pointer to image bits
#define LC_PROP_G_CAMERA_BPROW  81   // R  int; bytes per row
...
//^ #define LC_PROP_G_JL_ACOLOR     214  // RW int; Color of jump arrow, RGB value (COLORREF) 
//^ #define LC_PROP_G_JL_NUMFONT    215  // RW string; Numbers font name, 0 means default GUI font
//^ #define LC_PROP_G_JL_NUMSIZE    216  // RW int; Numbers font size, ignored if the font name is empty
//^ #define LC_PROP_G_JL_NUMCOLOR   217  // RW int; Color of numbers, RGB value (COLORREF) 
//^ #define LC_PROP_G_JL_DRAWJARR   218  // RW bool; Draw arrows of jump lines 
//^ #define LC_PROP_G_JL_DRAWJLINE  219  // RW bool; Draw jump lines (between entities)
...
#define LC_PROP_G_OSNAP_MARKSIZE   228   // RW int;  half-size of marker indicating snap point, pixels (1-15)
#define LC_PROP_G_OSNAP_APERSIZE   229   // RW int;  half-size of square around cursor, used for snap, pixels (1-15)
#define LC_PROP_G_OSNAP_MARKCOLOR  230   // RW int;  color of osnap marker (COLORREF)

//^ #define LC_PROP_G_ORDSEQ_AUTO     231   // RW bool;  Auto-sort connected entities (LC_CMD_ORDER_SEQ)

#define LC_PROP_G_EMUL_OVERDIST   232   // RW float; Min. dist to treat near lines as overlapped
...
#define LC_PROP_G_RAS_COLOR       251   // RW bool; enable colors  when save as raster image
...
#define LC_PROP_WND_PIXELSIZE       304    // RW float; Current scale of the drawing in the window, units per pixel
...
#define LC_PROP_WND_NAVIGATOR       331    // RW bool; display "Aerial View" window
#define LC_PROP_WND_COLORBG         332    // RW int; background color
#define LC_PROP_WND_COLORCURSOR     333    // RW int; cursor color
#define LC_PROP_WND_COLORFORE       334    // RW int; foreground color
#define LC_PROP_WND_COLORINFBG      335    // RW int; info box background color
#define LC_PROP_WND_COLORINFBORD    336    // RW int; info box border color
#define LC_PROP_WND_COLORINFTEXT    337    // RW int; info box text color
...
#define LC_PROP_WND_BLKBASEPT       352    // RW bool; display block basepoint
#define LC_PROP_WND_SIZE            353    // R  string; window size, pixels (format "%d x %d", PSWidth(), PSHeight() )
#define LC_PROP_WND_DTIME           354    // R  int; redraw time, milliseconds
...
#define LC_PROP_WND_FROZENVIEW      357    // RW bool; if true - can't chnage view rect
#define LC_PROP_WND_COMMAND         358    // R  int|handle|bool; Id of active command | handle to active command | TRUE if has active command
#define LC_PROP_WND_CMD             358    // same as LC_PROP_WND_COMMAND
#define LC_PROP_WND_CMDENT1         359    // RW bool; TRUE - only one entity added by command, FALSE - several entities
#define LC_PROP_WND_OSNAP           360    // RW int|bool; object snap mode  LC_OSNAP_NODE and others | On/Off
#define LC_PROP_WND_OSNAPMENU       361    // RW bool; display "object snap" menu on <shift>+<RBDown> (CBaseWnd::BaseOnRButtonDown)
#define LC_PROP_WND_ORTHO           362    // RW bool; ortho mode
#define LC_PROP_WND_PTRACK          363    // RW bool; polar tracking on/off
#define LC_PROP_WND_PTRACK_ANGLE    364    // RW float; step angle for polar tracking
#define LC_PROP_WND_PTRACK_DIST     365    // RW bool|float; use distance step along polar vector | value of dist. step
#define LC_PROP_WND_BASEPT          367    // R  bool; Has Base point   // undoc
#define LC_PROP_WND_BASEX           368    // R  float; Base point position X   // undoc
#define LC_PROP_WND_BASEY           369    // R  float; Base point position Y   // undoc
...
#define LC_PROP_WND_RSNAP           382    // RW bool; Enable snap to rectangle border
#define LC_PROP_WND_RSNAPSHOW       383    // RW bool; Display snap rectanle
#define LC_PROP_WND_RSNAPLEF        384    // RW float; X left
#define LC_PROP_WND_RSNAPBOT        385    // RW float; Y bottom
#define LC_PROP_WND_RSNAPRIG        386    // RW float; X right
#define LC_PROP_WND_RSNAPTOP        387    // RW float; Y top
#define LC_PROP_WND_RSNAPW          388    // RW float; Width (from X left)
#define LC_PROP_WND_RSNAPH          389    // RW float; Height (from Y bottom)
#define LC_PROP_WND_RSNAPCOLORM     390    // RW int; Rectangle filling color on Model space
#define LC_PROP_WND_RSNAPCOLORP     391    // RW int; Rectangle filling color on Paper space

#define LC_PROP_WND_PANSTEP         400    // RW int; Minimal step, pixels
#define LC_PROP_WND_PANLW           401    // RW bool; optimize line width (draw as 1pix size)
#define LC_PROP_WND_PANIMAGE        402    // RW bool; optimize raster images (draw as hatch)
#define LC_PROP_WND_PANFILL         403    // RW bool; optimize polygon filling (don't fill)
#define LC_PROP_WND_PANPIXSZ        404    // RW bool; reduce resolution (increase pixel size)

#define LC_PROP_WND_MEASCOLORPNT    410    // RW int; COLORREF for points of DIST, AREA tools
#define LC_PROP_WND_MEASCOLORLINE   411    // RW int; COLORREF for lines of DIST, AREA tools
#define LC_PROP_WND_MEASLINESIZE    412    // RW int; line size for DIST, AREA tools
#define LC_PROP_WND_MEASFONTSIZE    413    // RW int; font size
#define LC_PROP_WND_MEASFILLAREA    414    // RW int; fill area polygons with hatch

#define LC_PROP_WND_KBMOVE_ENABLE   417    // RW bool; enable movement by keyboard
#define LC_PROP_WND_KBMOVE_DIST     418    // RW float; distance step
#define LC_PROP_WND_KBMOVE_ANGLE    419    // RW float; angle step
#define LC_PROP_WND_KBMOVE_SCALE    420    // RW float; scale step
...
#define LC_PROP_WND_BGIMAGE         425    // RW string|bool; Background image filename | Display
#define LC_PROP_WND_LTVIEWMIN       426    // RW int; Linetype visibility, min size of pattern, pixels
#define LC_PROP_WND_LTVIEWMAX       427    // RW int; Linetype visibility, max size of pattern, pixels
#define LC_PROP_WND_TINEXT          428    // RW bool; consider TIN extents for a drawing's extents
#define LC_PROP_WND_DRAWSELHF       432    // RW bool; Draw hatch fill of selected entities
#define LC_PROP_WND_DRAWGRIPNUM     433    // RW bool; Draw grip number

#define LC_PROP_WND_FRAME_LEFT      496    // R  int; Left position on parent window (pixels)
#define LC_PROP_WND_FRAME_TOP       497    // R  int; Top position on parent window (pixels)
#define LC_PROP_WND_FRAME_WIDTH     498    // R  int; Frame width (pixels)
#define LC_PROP_WND_FRAME_HEIGHT    499    // R  int; Frame height (pixels)
...
// TIN point
#define LC_PROP_TIN_PNT__MIN     701
#define LC_PROP_TIN_PNT_I        701  // R  int; index
#define LC_PROP_TIN_PNT_X        702  // RW float; 
#define LC_PROP_TIN_PNT_Y        703  // RW float; 
#define LC_PROP_TIN_PNT_Z        704  // RW float; 
#define LC_PROP_TIN_PNT_NAME     705  // RW string; 
#define LC_PROP_TIN_PNT_DESCR    706  // RW string; 
#define LC_PROP_TIN_PNT_ICOLOR   707  // RW int; index of color (0...LC_PROP_TIN_NCOLPNT-1)
#define LC_PROP_TIN_PNT_IMGFILE  708  // RW string
#define LC_PROP_TIN_PNT_IMGFILE2 709  // R  string; full filename with path
#define LC_PROP_TIN_PNT_ATTR     710  // RW string
#define LC_PROP_TIN_PNT_ATTR1    711  // RW string
#define LC_PROP_TIN_PNT_ATTR2    712  // RW string
#define LC_PROP_TIN_PNT_ATTR3    713  // RW string
#define LC_PROP_TIN_PNT_ATTR4    714  // RW string
#define LC_PROP_TIN_PNT_ATTR5    715  // RW string
#define LC_PROP_TIN_PNT_ATTR6    716  // RW string
#define LC_PROP_TIN_PNT_ATTR7    717  // RW string
#define LC_PROP_TIN_PNT_ATTR8    718  // RW string
#define LC_PROP_TIN_PNT_ATTR9    719  // RW string
#define LC_PROP_TIN_PNT__MAX     730

// TIN triangle
#define LC_PROP_TIN_TR__MIN      731
#define LC_PROP_TIN_TR_I         731  // R int; index
#define LC_PROP_TIN_TR_PT0       732  // R handle; 
#define LC_PROP_TIN_TR_PT1       733  // R handle; 
#define LC_PROP_TIN_TR_PT2       734  // R handle; 
#define LC_PROP_TIN_TR_PT0X      735  // R  float; X of point0
#define LC_PROP_TIN_TR_PT0Y      736  // R  float; Y of point0 
#define LC_PROP_TIN_TR_PT0Z      737  // R  float; Z of point0 
#define LC_PROP_TIN_TR_PT1X      738  // R  float; X of point1
#define LC_PROP_TIN_TR_PT1Y      739  // R  float; Y of point1  
#define LC_PROP_TIN_TR_PT1Z      740  // R  float; Z of point1  
#define LC_PROP_TIN_TR_PT2X      741  // R  float; X of point2 
#define LC_PROP_TIN_TR_PT2Y      742  // R  float; Y of point2  
#define LC_PROP_TIN_TR_PT2Z      743  // R  float; Z of point2  
#define LC_PROP_TIN_TR_XC        744  // R  float; X of center point
#define LC_PROP_TIN_TR_YC        745  // R  float; Y of center point
#define LC_PROP_TIN_TR_ZC        746  // R  float; Z of center point
#define LC_PROP_TIN_TR_NVX       747  // R  float; X of normal vector
#define LC_PROP_TIN_TR_NVY       748  // R  float; Y of normal vector
#define LC_PROP_TIN_TR_NVZ       749  // R  float; Z of normal vector
#define LC_PROP_TIN_TR_NANG      750  // R  float; normal vector angle at XY plane
#define LC_PROP_TIN_TR_XMIN      751  // R  float; extents
#define LC_PROP_TIN_TR_YMIN      752  // R  float; 
#define LC_PROP_TIN_TR_ZMIN      753  // R  float; 
#define LC_PROP_TIN_TR_XMAX      754  // R  float; 
#define LC_PROP_TIN_TR_YMAX      755  // R  float; 
#define LC_PROP_TIN_TR_ZMAX      756  // R  float; 
#define LC_PROP_TIN_TR_DX        757  // R  float; 
#define LC_PROP_TIN_TR_DY        758  // R  float; 
#define LC_PROP_TIN_TR_DZ        759  // R  float; 
#define LC_PROP_TIN_TR_FLAGS     760  // RW int; 0-255 
#define LC_PROP_TIN_TR_MARK      761  // RW bool; marked triangle
#define LC_PROP_TIN_TR__MAX      800

// TIN point type

// Triangulated Irregular Network (TIN) (also lcTIN_Clear and others)
#define LC_PROP_TIN__MIN         1801
#define LC_PROP_TIN_FILENAME     1801  // R  string; model filename
#define LC_PROP_TIN_EMBEDDED     1802  // R  bool;
#define LC_PROP_TIN_XMIN         1805  // R  float; Xmin
#define LC_PROP_TIN_XMAX         1806  // R  float; Xmax
#define LC_PROP_TIN_YMIN         1807  // R  float; Ymin
#define LC_PROP_TIN_YMAX         1808  // R  float; Ymax
#define LC_PROP_TIN_ZMIN         1809  // R  float; Zmin
#define LC_PROP_TIN_ZMAX         1810  // R  float; Zmax
#define LC_PROP_TIN_DX           1811  // R  float; delta X
#define LC_PROP_TIN_DY           1812  // R  float; delta Y
#define LC_PROP_TIN_DZ           1813  // R  float; delta Z
#define LC_PROP_TIN_NPOINTS      1814  // R  int
#define LC_PROP_TIN_NTRIANS      1815  // R  int
#define LC_PROP_TIN_NBNDPTS      1816  // R  int; number of boundary points
#define LC_PROP_TIN_NISOLINES    1817  // R  int; number of isolines
#define LC_PROP_TIN_VIEWPT       1821  // RW bool; point
#define LC_PROP_TIN_VIEWPTN      1822  // RW bool; point type name
#define LC_PROP_TIN_VIEWPTI      1823  // RW bool; point index
#define LC_PROP_TIN_VIEWPTZ      1824  // RW bool; point Z
#define LC_PROP_TIN_VIEWTR       1825  // RW bool; triangle
#define LC_PROP_TIN_VIEWTRF      1826  // RW bool; triangle filling
#define LC_PROP_TIN_VIEWTRI      1827  // RW bool; triangle's index
#define LC_PROP_TIN_VIEWTRV      1828  // RW bool; triangle's waterflow vector
#define LC_PROP_TIN_VIEWBND      1829  // RW bool; boundary
#define LC_PROP_TIN_VIEWBNDI     1830  // RW bool; boundary vertex index
#define LC_PROP_TIN_VIEWISO      1831  // RW bool; isolines
#define LC_PROP_TIN_VIEWISOH     1832  // RW bool; heights of isolines
#define LC_PROP_TIN_FILLMODE     1833  // RW int; 0-gray; 1-color; 2-dark color
#define LC_PROP_TIN_FILLDZ       1834  // RW float/bool; Zstep|Use ranges
#define LC_PROP_TIN_NCOLPNT      1841  // RW int; number of point colors
#define LC_PROP_TIN_ICOLPNT      1842  // RW int; index of current point color (0...LC_PROP_TIN_NCOLPNT-1)
#define LC_PROP_TIN_COLPNT       1843  // RW int; default color for points (COLORREF)
#define LC_PROP_TIN_COLTR        1844  // RW int; color for triangle's edges (COLORREF)
#define LC_PROP_TIN_COLTRI       1845  // RW int; color for triangle's index (COLORREF)
#define LC_PROP_TIN_COLTRV       1846  // RW int; color for triangle's vector (COLORREF)
#define LC_PROP_TIN_COLISO       1847  // RW int; color for isolines (COLORREF)
#define LC_PROP_TIN_COLISOB      1848  // RW int; color for bold isolines (COLORREF)
#define LC_PROP_TIN_ISOSTEP      1851  // RW float; Z step of isolines 
#define LC_PROP_TIN_ISOBOLD      1852  // RW int; interval for bold isolined 
#define LC_PROP_TIN_ISOBASE      1853  // RW float; start Z for isoline step
#define LC_PROP_TIN_IMGDIR       1859  // RW string; images directory
#define LC_PROP_TIN__MAX         1860  

// Grid (by lcGrid... functions)
#define LC_PROP_GRID__MIN        1861
#define LC_PROP_GRID_XMIN        1862  // R  float; Xmin
#define LC_PROP_GRID_XMAX        1863  // R  float; Xmax
#define LC_PROP_GRID_YMIN        1864  // R  float; Ymin
#define LC_PROP_GRID_YMAX        1865  // R  float; Ymax
#define LC_PROP_GRID_W           1866  // R  float; delta X
#define LC_PROP_GRID_H           1867  // R  float; delta Y
#define LC_PROP_GRID_NCELLX      1868  // R  int; number of cells by X
#define LC_PROP_GRID_NCELLY      1869  // R  int; number of cells by Y
#define LC_PROP_GRID__MAX        1880  
...
#define LC_PROP_DRW_BLKREFGRIPS     3014    // RW int; BlockRef grips: 0-all grips, 1-only Pos, 2-Pos&Rotation
...
#define LC_PROP_DRW_JL_LAYER        3018    // RW bool; enable layers for jump lines (add column in "Layers" dialog)
#define LC_PROP_DRW_EXTOFFLAYER     3019    // RW bool; enable invisible layers for extents calculation
#define LC_PROP_DRW_HBSOLIDFILL     3020    // RW bool; Enable hatch brush for solid fill
...
#define LC_PROP_DRW_BARCTYPE        3061    // RW int; active barcode type, LC_BARTYPE_CODE39 and others
#define LC_PROP_DRW_BARCSOLID       3062    // RW bool; draw barcode without filling option
#define LC_PROP_DRW_LWMODE          3063    // RW int;  line width mode (LC_LW_THIN, LC_LW_REAL, LC_LW_PIXEL)
#define LC_PROP_DRW_LWSCALE         3064    // RW float; line width screen scale, mm / pixel
#define LC_PROP_DRW_LWIDTH          3065    // RW int; active Linewidth (for new entities)
#define LC_PROP_DRW_LWDEFAULT       3066    // RW int; Default linewidth (if linewidth==LC_LWIDTH_DEFAULT)
...
#define LC_PROP_LAYER_JUMPLINES     4118  // RW bool; enable jump lines for entities of this layer
#define LC_PROP_LAYER_OSNAP         4119  // RW bool; enable object snap for entities of this layer
...
#define LC_PROP_TSTYLE_WINFONT      4188  // RW bool; if TRUE - Windows True Type font is used
...
#define LC_PROP_TSTYLE_ITALIC       4193  // RW bool; "Italic" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_UNDERLINE    4194  // RW bool; "Underline" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_STRIKEOUT    4195  // RW bool; "Strikeout" flag (for LC_ENT_TEXTWIN)
#define LC_PROP_TSTYLE_MONOWIDTH    4196  // RW float; Width for monospaced font (0.0 - use default)
...
#define LC_PROP_ENT_LINFILL       5018  // RW handle|string; Handle to Lfilling type|Name of Lfilling type
#define LC_PROP_ENT_LAYER         5020  // RW handle|string; Handle to Layer|Name of Layer
#define LC_PROP_ENT_LINETYPE      5021  // RW handle|string; Handle to Linetype|Name of Linetype
...
#define LC_PROP_ENT_BLOCK         5024  // R  handle|string; Handle to Block|Name of Block
...
#define LC_PROP_ENT_Z             5051  // RW float; Z coord for 2D objects
...
#define LC_PROP_ENT_LEN           5060  // R  float; length (line, pline, arc, circle, ellipse, rect)
...
#define LC_PROP_TEXTW_STYLE      5431  // RW handle|string; Handle to text style|Name of text style
#define LC_PROP_TEXTW_STR        5432  // RW string; Text content
#define LC_PROP_TEXTW_STRT       5433  // R  string; Text content (with translated codes)
#define LC_PROP_TEXTW_LEN        5434  // R  int; Number of characters in the Text string
...
#define LC_PROP_TEXTW_DX         5440  // RW int; Offset X (valid if Pixel Height is true)
#define LC_PROP_TEXTW_DY         5441  // RW int; Offset Y (valid if Pixel Height is true)
...
#define LC_PROP_IMGREF_UNSALIGN   5580  // RW int; Alignment of unscalable image, relative to LC_PROP_IMGREF_XC, LC_PROP_IMGREF_YC (LC_IMGA_CENTER or other)
...
#define LC_PROP_HATCH_NENTS      5639  // R  int; number of boundary entities (for Associative hatch)
...
#define LC_PROP_HATCH_FALPHA     5644  // RW int; transparency alpha value (only for Solid hatch)
...
#define LC_PROP_BARC_NBARS       5777  // R  int; same as LC_PROP_BARC_NMODX (for 1D - number of bars)
...
#define LC_EVENT_SELECT          151
#define LC_EVENT_PICKENT         152
#define LC_EVENT_ADDSTR          153
#define LC_EVENT_ADDCMD          154
#define LC_EVENT_CCMD            155
...
// TIN object (also LC_PROP_TIN_FILENAME and others)
BOOL   LCAPI lcTIN_Clear         ();
BOOL   LCAPI lcTIN_FileLoad      (LPCWSTR szFileName, HANDLE hLcWnd);
BOOL   LCAPI lcTIN_FileSave      (LPCWSTR szFileName, HANDLE hLcWnd);
BOOL   LCAPI lcTIN_Update        ();

HANDLE LCAPI lcTIN_AddPoint      (double X, double Y, double Z);
HANDLE LCAPI lcTIN_AddPoint2     (double X, double Y, double Z, LPCWSTR szName, LPCWSTR szDescr, int iColor);
int    LCAPI lcTIN_LoadPoints    (LPCWSTR szFileName, HANDLE hLcWnd);
int    LCAPI lcTIN_DelDupPoints  (double Delta);
BOOL   LCAPI lcTIN_DelPoint      (HANDLE hPnt);
HANDLE LCAPI lcTIN_GetFirstPoint ();
HANDLE LCAPI lcTIN_GetNextPoint  (HANDLE hPnt);
HANDLE LCAPI lcTIN_GetPointI     (int Index);

HANDLE LCAPI lcTIN_AddTrian      (HANDLE hPnt1, HANDLE hPnt2, HANDLE hPnt3);
HANDLE LCAPI lcTIN_AddTrianI     (int iPnt1, int iPnt, int iPnt3);
BOOL   LCAPI lcTIN_DelTrian      (HANDLE hTrian);
int    LCAPI lcTIN_DelTriansByPline (HANDLE hPline);
HANDLE LCAPI lcTIN_GetFirstTrian ();
HANDLE LCAPI lcTIN_GetNextTrian  (HANDLE hTrian);
BOOL   LCAPI lcTIN_NormTrians    ();

BOOL   LCAPI lcTIN_Triangulate   ();  // LC_CMD_TIN_BNDTRANG
BOOL   LCAPI lcTIN_BndClear      ();
BOOL   LCAPI lcTIN_BndAuto       (double MaxDist, HANDLE hLcWnd);
BOOL   LCAPI lcTIN_BndAddPoint   (HANDLE hPnt);
BOOL   LCAPI lcTIN_BndUpdate     ();
HANDLE LCAPI lcTIN_BndGetPoint   (int iPnt);
BOOL   LCAPI lcTIN_BndFileSave   (LPCWSTR szFileName, HANDLE hLcWnd);
int    LCAPI lcTIN_BndOffset     (double dX, double dY, double dZ);

BOOL   LCAPI lcTIN_GetZ          (double X, double Y, double* pZ);
int    LCAPI lcTIN_InterLine     (double X0, double Y0, double X1, double Y1);
BOOL   LCAPI lcTIN_InterGetPoint (int iPnt, double* pX, double* pY, double* pZ);
HANDLE LCAPI lcTIN_GetNearPoint  (double X, double Y);

int    LCAPI lcTIN_GenIsolines    ();
HANDLE LCAPI lcTIN_GetFirstIso    ();
HANDLE LCAPI lcTIN_GetNextIso     (HANDLE hIso);
double LCAPI lcTIN_IsoGetHeight   (HANDLE hIso);
int    LCAPI lcTIN_IsoGetNumVers  (HANDLE hIso);
BOOL   LCAPI lcTIN_IsoIsClosed    (HANDLE hIso);
...
HANDLE LCAPI lcTIN_IsoGetFirstVer (HANDLE hIso);
HANDLE LCAPI lcTIN_IsoGetNextVer  (HANDLE hIso, HANDLE hVer);
BOOL   LCAPI lcTIN_IsoGetVerXY    (HANDLE hVer, double* pX, double* pY);
...
// Status Bar
HANDLE LCAPI lcCreateStatbar (HWND hWndParent);   // also LC_PROP_SBAR_H and others
...
BOOL   LCAPI lcDrwSaveCB          (HANDLE hDrw); 
BOOL   LCAPI lcDrwLoadCB          (HANDLE hDrw, HANDLE hLcWnd);
...
BOOL   LCAPI lcBlockScale        (HANDLE hBlock, double X, double Y, double Scale, BOOL bUpdate);
...
BOOL   LCAPI lcBlockSortEnts2   (HANDLE hBlock, HANDLE idEnts, int nEnts);   // for DWG plugin
...
HANDLE LCAPI lcBlockAddImageRefUns (HANDLE hBlock, HANDLE hImage, double X, double Y, double Scale, int Align, BOOL bBorder);
...
HANDLE LCAPI lcBlockJoinAll     (HANDLE hBlock, double Delta);
...
HANDLE LCAPI lcBlockGetBlkRefByTag (HANDLE hBlock, LPCWSTR szTag, LPCWSTR szValue, BOOL bSelect);
...
BOOL   LCAPI lcPlineMakeArrow   (HANDLE hPline, double Hline, double Harr);  // undoc
HANDLE LCAPI lcPlineSplitBySI   (HANDLE hPline, BOOL bSelect, BOOL bErase);  // undoc
...
// Block attribute
HANDLE LCAPI lcBlkRefAddAtt      (HANDLE hBlockRef, LPCWSTR szTag, LPCWSTR szValue);  // for using in DWG plugin
...
BOOL   LCAPI lcFillet          (double Rad, double Bis, double Tang);  // undoc
...
BOOL LCAPI lcPrintBlock  (HANDLE hBlock, double X, double Y, double W, double H, double Scale, double PapLef, double PapTop, int Options);
