...
BEGIN_MESSAGE_MAP(CHomeView, CBaseFormView)
	...
	ON_BN_CLICKED(IDC_BTN_2D_SET, &CHomeView::OnBnClickedBtn2dSet) // dhpark 2023.06.26
	ON_COMMAND(ID_BUTTON_2D_RESULT, &CHomeView::OnButton2dResult)
END_MESSAGE_MAP()
...
//	pDoc->StartWork(FALSE, 1.0f, 1.0f);
}
