...
namespace MIS.Common
{
    public class ConfigINI
    {
        ...
        // sjyi 2024.04.18 시스템키(F10) 사용 유무
        public bool m_bUseSystemKey { get; set; }
        ...
        public bool m_bJudgeByPLC { get; set; }  // sjyi 2024.05.30 PLC 판정 사용 유무

        // sjyi 2024.06.15, PLC에서 제공하는 Ext Info 시작 주소 추가
        public string PLC_ReadExtInfo_A { get; set; }
        public string PLC_ReadExtInfo_B { get; set; }
        ...
        public bool ReadConfig()
        {
            ...
            // sjyi 2024.04.18 시스템키(F10) 사용 유무 추가
            m_bUseSystemKey = Convert.ToBoolean(GetINIString("SYSTEM", "USE_F10_KEY", "false"));
            ...
            PLC_ReadExtInfo_A = GetINIString("PLC_INFO", "ReadEXTInfo_A", "51040"); // sjyi 2024.06.15, PLC에서 제공하는 Ext Info 시작 주소 추가
            PLC_ReadExtInfo_B = GetINIString("PLC_INFO", "ReadEXTInfo_B", "51060"); // sjyi 2024.06.15, PLC에서 제공하는 Ext Info 시작 주소 추가
            ...
            // sjyi 2024.05.30 PLC 판정 사용 유무 추가
            m_bJudgeByPLC = Convert.ToBoolean(GetINIString("HAIRPIN_INFO", "JUDGE_BY_PLC", "false"));
        ...
        public bool WriteConfig()
        {
            ...
            // sjyi 2024.04.18 시스템키(F10) 사용 유무 추가
            WritePrivateProfileString("SYSTEM", "USE_F10_KEY", m_bUseSystemKey.ToString(), InIPath);
            ...
            WritePrivateProfileString("PLC_INFO", "ReadEXTInfo_A", PLC_ReadExtInfo_A, InIPath); // sjyi 2024.06.15, PLC에서 제공하는 Ext Info 시작 주소 추가
            WritePrivateProfileString("PLC_INFO", "ReadEXTInfo_B", PLC_ReadExtInfo_B, InIPath); // sjyi 2024.06.15, PLC에서 제공하는 Ext Info 시작 주소 추가
            ...
            // sjyi 2024.05.30 PLC 판정 사용 유무 추가
            WritePrivateProfileString("HAIRPIN_INFO", "JUDGE_BY_PLC", m_bJudgeByPLC.ToString(), InIPath);
