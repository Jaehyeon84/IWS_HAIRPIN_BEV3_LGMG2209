...
BOOL CDlgManualScan::OnInitDialog()
{
	...
	// 2022.10.27 jh.kim 수정
	////m_editPower.SetValue(3);
	//m_editPower.SetValue(5);
	switch (m_pDoc->m_config.m_iLaser)
	{
	case TRUMPF_TRUDISK: m_editPower.SetValue(3); break;
	case COHERENT_ROFIN: m_editPower.SetValue(5); break;
	}	
...
void CDlgManualScan::OnBnClickedLaserEnable()
{
	...
	// 2022.08.05 jh.kim 변경 - 2022.10.27 변경
...
void CDlgManualScan::OnBnClickedLaserEmission()
{
	...
	// 2022.08.05 jh.kim 추가
	dPower = m_pScan->GetDOGuideOn() ? 0 : dPower;
