...
public:
	...
	virtual BOOL GetDILaserOn() { return m_pScanner->DI(DI_LaserOn); };	// Standby Ready
	virtual BOOL GetDIEmission() { return m_pScanner->DI(DI_EmissionOn); };	// Laser Beam Ready
...
public:
	...
	// COHER: Reset, Test warning , Mains ON, Standby ON
	...
	// COHER: L.B Ready, Standby Ready, General Fault, Warning
