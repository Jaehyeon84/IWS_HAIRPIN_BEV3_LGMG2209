...
CSxGroupBox::CSxGroupBox()
{
	...
	m_boxColor1_d = RGB(80, 80, 80);// ::GetSysColor(COLOR_3DSHADOW);
	m_boxColor2_d = RGB(80, 80, 80);// RGB(255, 170, 100);// RGB(121, 210, 231);
	...
	m_txtColor = RGB(80, 80, 80);// RGB(255, 170, 100);// RGB(121, 210, 231);// RGB(255, 255, 255);
	...
	m_txtAlignment = BS_LEFT;//BS_CENTER;
	...
	CSxLogFont Arial12b(100, 100, false, L"Arial");
	SetFont(&Arial12b);
}
