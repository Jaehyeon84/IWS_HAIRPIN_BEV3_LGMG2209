...
#include <vector>
#include <string>
#include "define_VRS.h"
#include "./NIVision/Include/nivision.h"


using namespace std;

/* declaration for main CCD */
...
/* declaration for 2nd CCD */
extern HANDLE	g_hEventSrtCopyDispData2nd;
extern HANDLE	g_hEventDisplayStart2nd;

extern double	g_AvgFrmRate2nd;
extern BOOL		g_bLiveDisplay2nd;
extern BOOL		g_bGrabThreadAlive2nd;

extern CString	g_strSimulImagePath2nd;

extern CRITICAL_SECTION G_cs2nd;
extern ImageType g_ImgType2nd;
extern BOOL		g_bCameraStateOK2nd;
