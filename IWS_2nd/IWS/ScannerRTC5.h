...
#ifdef _WIN64
	#pragma comment(lib, "API/x64/RTC5DLLx64.lib")
#else
	#pragma comment(lib, "API/RTC5DLL.lib")
#endif

class CScannerRTC5 : public CScanner
{
public:
	CScannerRTC5();	
	CScannerRTC5(CString strScannerPath, CString strConfigPath);
	// 2022.10.27 jh.kim Ãß°¡
	CScannerRTC5(CString strScannerPath, CString strConfigPath, int iLaser);
	~CScannerRTC5();
...
public:
	...
	virtual BOOL DI2(int pinnum);
	virtual void DO(int pinnum, BOOL flag);
	virtual void DO2(int pinnum, BOOL flag);
	virtual BOOL GetDO(int pinnum);
	virtual int GetDO_Value();
	virtual void DO_Value_List(int value);
