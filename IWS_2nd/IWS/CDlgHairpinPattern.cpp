...
void CDlgHairpinPattern::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_USE_REVERSAL_P1, m_bUseReversal); // sjyi 2024.02.28 헤어핀 외경(짝수열) 패턴 반전 기능 사용여부 추가
}
...
BEGIN_MESSAGE_MAP(CDlgHairpinPattern, CDialogEx)
	...
	ON_CONTROL_RANGE(BN_CLICKED, IDC_RADIO_1ST_1, IDC_RADIO_1ST_6, &CDlgHairpinPattern::OnBnClickedRadioLayerSelect1ST)
	ON_CONTROL_RANGE(BN_CLICKED, IDC_RADIO_Ell_P2, IDC_RADIO_Zigzag2_P2, &CDlgHairpinPattern::OnBnClickedRadio2ND)
	ON_CONTROL_RANGE(BN_CLICKED, IDC_RADIO_2ND_1, IDC_RADIO_2ND_6, &CDlgHairpinPattern::OnBnClickedRadioLayerSelect2ND)
...
void CDlgHairpinPattern::OnBnClickedOk()
{
	...
	m_dPtnRotation = m_editPtnRotation.GetValue(); // sjyi 2023.04.14 헤어핀 회전 추가
	m_dPtnRotation2 = m_editPtnRotation2.GetValue(); // sjyi 2023.04.14 헤어핀 회전 추가
...
void CDlgHairpinPattern::OnBnClickedRadio1ST(UINT uiD)
{
	...
	{
	case 0:	strBefWeldType.Format(L"Ellipse");	break;
	case 1:	strBefWeldType.Format(L"Line");	break;
	case 2:	strBefWeldType.Format(L"Zigzag");	break;
	case 3:	strBefWeldType.Format(L"Octagon");	break;
	}
	...
	switch (m_nWeldShapeP1)
	{
	case 0:	strAftWeldType.Format(L"Ellipse");	break;
	case 1:	strAftWeldType.Format(L"Line");	break;
	case 2:	strAftWeldType.Format(L"Zigzag");	break;
	case 3:	strAftWeldType.Format(L"Octagon");	break;
	}
...
void CDlgHairpinPattern::OnBnClickedRadio2ND(UINT uiD)
{
	...
	case 1: strBefWeldType.Format(L"Line");	break;
	case 2:strBefWeldType.Format(L"Zigzag");	break;
	case 3:strBefWeldType.Format(L"Zigzag2");	break; // sjyi 2022-05-23 ZigZag2 패턴 추가
	}
	...
	case 1: strAftWeldType.Format(L"Line");	break;
	case 2:	strAftWeldType.Format(L"Zigzag");	break;
	case 3: strAftWeldType.Format(L"Zigzag2");	break; // sjyi 2022-05-23 ZigZag2 패턴 추가
	}
...
void CDlgHairpinPattern::OnBnClickedRadioLayerSelect1ST(UINT uiD)
{
	...
	case 5:	strBefType.Format(L"None");	break;
	}
	...
	case 5:	strAftType.Format(L"None");	break;
	}
...
//		GetDlgItem(IDC_EDIT_PREQ_P2)->ShowWindow(FALSE);
