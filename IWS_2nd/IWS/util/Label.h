...
public:
	...
	void	SetInvalidate(BOOL bSet) { m_bInvalidate = bSet; }	// blue 2009.09.14 
...
protected:
	...
	// blue 2009.09.14 화면 깜빡임 없앨라고..
	CString			m_strText;
	BOOL			m_bInvalidate;	// default : TRUE - 기존 코드.
									// SetInvalidate(FALSE) 로 설정하면 타이머 돌때 깜빡임 제거.
