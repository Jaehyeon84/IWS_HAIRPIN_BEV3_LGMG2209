...
namespace MIS.Common
{
    ...
    public class JSONReader
    {
        ...
        public void MakeEIDS(string FilePath, List<InspDataGMES> InsptData, string strModelNum, int nReworkCnt, string strBarCode, string strJigType, EPDS producData, EAYT_R EQPData, string strFinalJudgement)
        {
            JObject jobRoot = new JObject();
