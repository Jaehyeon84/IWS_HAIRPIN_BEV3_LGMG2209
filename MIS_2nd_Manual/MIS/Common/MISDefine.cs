...
{
    public enum INPUT_FRAME { LINK = 0 };
    public enum OUTPUT_FRAME { LINK = 0 };
    ...
    public class EPDS
    {
        ...
        public string strWeldEquipID = ""; // sjyi 2024.01.15, Welding Equip ID

        public string strInspResult = ""; // sjyi 2024.05.09 추가, 이전장비 최종 검사 결과

        public List<ProductWeldingInfo> LsSubWedingInfo = new List<ProductWeldingInfo>(); // sjyi 2024.01.15 Welding Info String 추가
    }
    ...
    public class ProductWeldingInfo
    {
        public string strWeldInfoName;      // Slot Layer 정보 
        public string strWeldInfoResult;    // 용접 검사 결과
    }
